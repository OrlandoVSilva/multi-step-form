...
export const AddOnsMonthlyOptions = () => {

    useEffect(() => {
        const onlineServiceCheck = document.getElementById("online-service-monthly");
        const largerStorageCheck = document.getElementById("larger-storage-monthly");
        const customizableProfileCheck = document.getElementById("customizable-profile-monthly");
        ...
        largerStorageCheck.addEventListener("click", () => {
            if (!largerStorageValue) {
                ...
                largerStorageCheck.style.backgroundColor = "transparent";
    ...
    return (
        <div id="add-ons-monthly-options">
            <div className="options-card" id="option-online-service">
                <div className="checkbox-section">
                    <div className="checkbox" id="online-service-monthly"></div>
                </div>
            ...
            <div className="options-card" id="option-larger-storage">
                <div className="checkbox-section">
                    <div className="checkbox" id="larger-storage-monthly"></div>
                </div>
                <div className="checkbox-label">
                    <p>Larger storage</p>
            ...
            <div className="options-card" id="option-customizable-profile">
                <div className="checkbox-section">
                    <div className="checkbox" id="customizable-profile-monthly"></div>
                </div>
                <div className="checkbox-label">
